<?php
/**
* script for bulk course guest enable operations
*/
...
if ($confirm and confirm_sesskey()) {
    ...
    $formcontinue = new single_button(new moodle_url('enable_guest.php', array('confirm' => 1)), get_string('yes'));
    $formcancel = new single_button(new moodle_url('index.php'), get_string('no'), 'get');
    echo $OUTPUT->confirm(get_string('confirmenableguest', 'tool_export_student', $coursenames), $formcontinue, $formcancel);
}
